        ...
        <nav style={{ backgroundColor: "rgb(221, 223, 246)" }} className=" border-gray-200 dark:bg-gray-900">
            <div className="flex flex-wrap items-center justify-between p-3">
                ...
                <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    {/* User dropdown menu */}
                    {isUserMenuOpen && (
                        <div className="z-50 absolute right-20 top-24 mt-2 w-48 text-base bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
